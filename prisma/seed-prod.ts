/**
 * Seed PRODUKSI — idempotent & non-destruktif.
 * Mengisi master data (rekening, kategori, tarif, target, parameter) + user owner,
 * TANPA menghapus data yang ada dan TANPA transaksi contoh (mulai bersih).
 * Aman dijalankan berkali-kali. Jalankan: npm run seed:prod
 */
...
async function main() {
  console.log("🌱 Seed produksi (idempotent) ...");
